                    ...
                    <Col xl={4} lg={12} className='mt-xl-0 mt-5'>
                        ...
                        <Modal show={show1} onHide={handleClose1}>
                            ...
                            <Button variant="secondary" onClick={handleClose1}>
                                ...
                                <a href="https://authscorp-landingpage.vercel.app/" className='text-light link-portfolio btn btn-primary' target='_blank' rel='noopener noreferrer' onClick={handleClose1}>See More</a>
                            </Modal.Footer>
                        </Modal>
                    </Col>
                    <Col xl={4} lg={12} className='mt-xl-0 mt-5'>
